...
class Compiler {
    ...
    public function compile(node:Node) {
        switch (node.type) {
            ...
            case NodeType.Plus | NodeType.Multiply | NodeType.Equal | NodeType.SmallerThan | NodeType.GreaterThan | NodeType.Minus | NodeType.Divide | NodeType.Modulo | NodeType.StringConc:
